...
menu = st.sidebar.selectbox("Elige una selección", ("Panorámica", "Carga tus datos", "Analiza las ventas"))
if menu == "Panorámica":
    ft.home()
    ...
    menu_ventas = st.sidebar.radio("Escoge lo que te interesa analizar",
                                   options=["Ventas por categoría", "Ventas por subcategoría", "Ventas por Estado"])
